...
public interface Constant {
  ...
  String ADDR_PLAYER_ANALYTICS_DB = ADDR_PLAYER + ".analytics.db";
  ...
  List<String> ADDRESS_SET = Arrays.asList(new String[] {
      ...
      ADDR_PLAYER_SWF_BUTTON, ADDR_PLAYER_SWF_WEBVIEW, ADDR_PLAYER_ANALYTICS_REQUEST,ADDR_PLAYER_ANALYTICS_DB,
      ...
      ADDR_TAG_STAR_SEARCH, ADDR_TAG_ATTACHMENT, ADDR_TAG_ATTACHMENT_SEARCH, ADDR_SVG});
